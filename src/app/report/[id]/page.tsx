  ...
  useEffect(() => {
    async function fetchReport() {
      try {
        ...
        if (data.status !== 'complete') throw new Error('Report is still processing');
    ...
    return (
      <main className="min-h-screen flex items-center justify-center px-4">
        <div className="text-center">
          ...
          <p className="text-gray-400 mb-8">{error || 'This report may have expired.'}</p>
