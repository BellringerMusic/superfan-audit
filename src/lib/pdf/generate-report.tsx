    ...
    <Page size="A4" style={styles.coverPage}>
      <View style={{ alignItems: 'center', padding: 60 }}>
        ...
        <Text style={{ fontSize: 12, color: colors.text, textAlign: 'center', maxWidth: 400, lineHeight: 1.8, marginBottom: 32 }}>
          This report is just the beginning. Learn the exact strategies that independent artists are using to build thriving fan-funded music careers.
        </Text>
        <View style={[styles.card, { width: 350, alignItems: 'center', padding: 24 }]}>
          ...
          <Text style={{ fontSize: 11, color: colors.textMuted, textAlign: 'center', lineHeight: 1.6 }}>
            Get weekly strategies for building superfan relationships and monetizing your music career.
          </Text>
        </View>
        <Text style={{ fontSize: 9, color: colors.textMuted, marginTop: 40, textAlign: 'center' }}>
